                ...
                <Card className="bg-white/10 border-[#F244C4]/30 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-4">
                        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <Label htmlFor="challenge" className="text-white/80 font-medium">
                                    Maior Desafio Hoje *
                                </Label>
                                <Textarea
                                    {...register("challenge")}
                            ...
                            <Button type="submit" className="w-full bg-[#F244C4] hover:bg-[#EF1BF2] text-white font-semibold py-3 rounded-full md:col-span-2">
