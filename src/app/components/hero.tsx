export default function Hero() {
    return (
        <section className="bg-black text-white py-24 px-4" id="hero">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <a
                    href="#contato"
                    className="mt-10 inline-block bg-white text-black px-6 py-3 rounded-full text-sm font-semibold hover:bg-gray-100 transition"
                >
